...
Usage:
    ...
    python phase4_evals/red_team.py --model tripmind-ft
...
def main() -> None:
    parser = argparse.ArgumentParser(description="TripMind red team")
    ...
    with tqdm(total=total, desc="Red team", unit="run") as pbar:
        for model_name in models:
            for prompt_type, persona_str in prompts:
                ...
                instruction = (
                    "Act as TripMind Supervisor for an Indian domestic trip. Coordinate the Analyst, "
                    ...
                    "Act as TripMind Optimizer. Given a traveler persona for an Indian domestic trip, "
