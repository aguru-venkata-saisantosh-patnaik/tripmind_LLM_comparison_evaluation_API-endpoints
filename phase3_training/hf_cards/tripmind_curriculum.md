...
**Notable:** Despite near-zero JSON validity, grounding accuracy (0.88) nearly matches tripmind-ft (0.895). The model has absorbed real-world knowledge about Indian cities and travel patterns — it simply cannot format the output as valid JSON after Phase 2 training overwrote structured-output behavior.
