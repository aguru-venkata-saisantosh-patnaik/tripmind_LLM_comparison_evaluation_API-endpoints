...
Part of the [TripMind](https://github.com/agurusantosh/tripmind) project. Unlike `tripmind-ft` (trained on clean synthetic pairs), this model was trained on agent reasoning chains — the hypothesis being that richer teacher signal improves generalization. Results were mixed: reasoning coherence improved, but structural output compliance dropped.
