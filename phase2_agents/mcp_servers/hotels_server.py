"""
TripMind MCP Hotels & Flights Server — port 8002
...
mcp = FastMCP("tripmind-hotels-flights", host="0.0.0.0", port=_PORT)
...
if __name__ == "__main__":
    log.info("Starting TripMind hotels/flights MCP server (OSM-powered)", port=_PORT)
