...
def _build_prompt(batch: list[dict]) -> str:
    ...
    if len(batch) == 1:
        ...
        return f"""You are TripMind, an Indian travel planner. Generate a baseline and optimized travel plan.
...
{{
  ...
  "pivot_analysis": "Explain which Area/Transit/Accommodation pivots saved money."
    ...
    return f"""You are TripMind, an Indian travel planner. Generate baseline and optimized travel plans.
...
def main():
    parser = argparse.ArgumentParser(description="TripMind Phase 1 — synthetic data generation")
